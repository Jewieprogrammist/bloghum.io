...
<body>
    ...
    <div class="content row container">
        <div class="main-content col-md-9 col-12">
            <h2 class="main-content-title">Publications</h2>
            <a href="create.php" class="btn btn-primary create_post">Create Post</a>
            <hr>
            <?php
            ...
            <?php while ($row = $res->fetch_assoc()) : ?>
                ...
                <div class="post row">
                    <div class='img col-8 col-md-4'>
                        <img src='images/<?php echo $row['image']; ?>' class='img-thumbnail'>
                    </div>
                    <div class="post_text col-12 col-md-8">
                        <a href="single.php?id=<?php echo $row['id']; ?>">
                            <h2 class="post_text_title"><?php echo $row['title'] ?></h2>
                        </a>
                        <i class="far fa-user"><?php echo $row['id_user']; ?></i>
                        <i class="far fa-calendar"><?php echo $row['created_date']; ?></i>

                        <a href="delete.php?id=<?php echo $row['id']; ?>" class="btn btn-danger delete">Delete</a>
